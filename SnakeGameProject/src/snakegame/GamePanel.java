...
public class GamePanel extends JPanel implements ActionListener {
	...
	public void draw(Graphics g) {
		...
		if (running) {
			System.out.println("if the running is true is called");
	...
	public void checkApple() {
		if ((x[0] == appleX) && (y[0] == appleY)) {
			System.out.println("checkApple method is called");
			bodyParts++;
			applesEaten++;
			newApple();
		}
	...
	public void checkCollisions() {
		System.out.println("checkCollisions method is called");
	...
	public void actionPerformed(ActionEvent e) {
		if (running) {
			System.out.println("it is only called the running is true");
			move();
			checkApple();
			checkCollisions();
		}
